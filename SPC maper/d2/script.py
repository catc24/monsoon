...
https://www.spc.noaa.gov/products/outlook/day2otlk_cat.kmz
...
# KMZ file path
KMZ_FILE = os.path.join(DATA_DIR, "day2otlk_cat.kmz")

# The main SPC outlook image (background)
SPC_OUTLOOK_IMAGE = os.path.join(IMAGES_DIR, "spc_day2_outlook_recreated.png")

# The overlay image (same size)
OVERLAY_IMAGE = "overlay.png"

# The final composited image
FINAL_IMAGE = os.path.join(IMAGES_DIR, "spc_day2_outlook_with_overlay.png")
...
# ------------------------------------------------------------------------------
def download_kmz():
    url = "https://www.spc.noaa.gov/products/outlook/day2otlk_cat.kmz"
